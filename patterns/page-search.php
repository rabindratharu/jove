...
/**
 * Title: Search Page
 * Slug: jove/page-search
 * Description: A full page design for a search page
 * Categories: jove/pages
 * Keywords: page, layout, design, template, search
 * Viewport Width: 1500
 * Block Types: 
 * Post Types: 
 * Inserter: true
...
<aquila-search class="aquila-search row px-4">
    <aquila-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
        <aquila-clear-all-filters class="clear-all-filters"><button class="btn btn-secondary">Clear All filters</button>
