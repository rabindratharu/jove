 ...
 * Slug: jove/footer-centered-light
 * Description: 
 * Categories: footer
 * Keywords: 
 * Viewport Width: 1500
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary","fontSize":"small","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
...
<p class="has-text-align-center has-secondary-color has-text-color has-link-color has-small-font-size">© 2024 · Powered by WordPress and <a href="https://www.jove.com">Jove</a></p>
<!-- /wp:paragraph -->
