 ...
 * Slug: jove/single-testimonial
 * Description: 
 * Categories: jove/testimonial, jove/features, jove/card
 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|x-large"},"blockGap":"var:preset|spacing|large"}},"backgroundColor":"main","layout":{"type":"constrained"}} -->
...
<p class="has-base-color has-text-color has-large-font-size" style="line-height:1.3">Wow, I really can't believe how powerful the WordPress Site Editor is combined with Jove. I don't even need a page builder!</p>
<!-- /wp:paragraph -->
