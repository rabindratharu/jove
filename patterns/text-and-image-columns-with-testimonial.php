 ...
 * Slug: jove/text-and-image-columns-with-testimonial
 * Description: 
 * Categories: jove/features, jove/testimonial
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Jove is built for the new WordPress Site Editor</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Did you know you can build a blazing-fast, fully-customizable website with the native WordPress editor now? Download the Jove block theme to start learning the new WordPress today!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
