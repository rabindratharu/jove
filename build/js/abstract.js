...
document.addEventListener("DOMContentLoaded", function () {
  var containers = document.querySelectorAll(".jove-abstract-block__share__link-copy");
  if (!containers.length) {
    return;
  }
  containers.forEach(function (element) {
    element.addEventListener("click", function () {
      var cloneLink = element.closest(".jove-abstract-block__share__link").querySelector(".jove-abstract-block__share__link-url").innerText; // Correctly selects the child
