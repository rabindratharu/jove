...
var getResultMarkup = function getResultMarkup() {
  ...
  posts.forEach(function (post) {
    ...
    markup += "\n\t\t<article id=\"video-".concat((_post$id = post === null || post === void 0 ? void 0 : post.id) !== null && _post$id !== void 0 ? _post$id : 0, "\" class=\"jove-video\">\n\t\t\t<h2 class=\"jove-video-title\">\n\t\t\t\t<a href=\"").concat((_post$permalink = post === null || post === void 0 ? void 0 : post.permalink) !== null && _post$permalink !== void 0 ? _post$permalink : "", "\" title=\"").concat((_post$title = post === null || post === void 0 ? void 0 : post.title) !== null && _post$title !== void 0 ? _post$title : "", "\">\n\t\t\t\t\t").concat((_post$title2 = post === null || post === void 0 ? void 0 : post.title) !== null && _post$title2 !== void 0 ? _post$title2 : "", "\n\t\t\t\t</a>\n\t\t\t</h2>\n\t\t\t<div class=\"jove-video-authors-affiliations\">\n\n\t\t\t</div>\n\t\t\t<div class=\"jove-video-meta\">\n\t\t\t\t<div class=\"jove-video-date\"><span>Published on:</span>").concat((_post$date = post === null || post === void 0 ? void 0 : post.date) !== null && _post$date !== void 0 ? _post$date : "", "</div>\n\t\t\t\t<div class=\"jove-video-journal\"><span>Journal:</span>").concat((_post$journal = post === null || post === void 0 ? void 0 : post.journal) !== null && _post$journal !== void 0 ? _post$journal : "", "</div>\n\t\t\t</div>\n\t\t</article>\n\t\t");
  });
  return markup;
};
