...
* Remove unnecessary jove slug from template part
...
= 1.0.7 - 10/2/23 =
* Remove Jove onboarding wizard in favor of plugin implementation in the coming weeks
...
* Add Jove Dashboard and Setup Wizard (Appearance → Jove)
...
* Prepare theme for Jove setup wizard. 
...
Jove Theme, (C) 2023 The JoVE Team
Jove is distributed under the terms of the GNU GPL.
...
logo-1.webp, logo-2.webp, logo-3.webp, logo-4.webp, logo-5.webp - created by The JoVE Team and available via CC0.
All images in /inc/settings/build/images/ created by The JoVE Team and available via CC0. 
